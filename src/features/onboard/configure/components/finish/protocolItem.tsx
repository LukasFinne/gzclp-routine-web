...
export const ExerciseTierThreeProtocolItem = ({exercise}: ExerciseTierThreeProtocolItemProps) => {
    return (
        <div className={" list-row"}>
            ...
            <div className={"space-x-1"}>
                Tier 3:{" "}
                <div
                    className="badge badge-primary">{exercise.protocol.set} x {exercise.protocol.reps}</div>
            </div>
        </div>
    )
}
...
export const ExerciseTierOneAndTwoProtocolItem = ({exercise}: ExerciseTierOneAndTwoProtocolItemProps) => {
    return (
        <div className={"list-row"}>
            <span className={"font-semibold"}>{exercise.name}:</span>
            <div className={"space-x-1"}>
