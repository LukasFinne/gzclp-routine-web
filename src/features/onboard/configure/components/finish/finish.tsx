...
import {ExerciseTierOneAndTwoProtocolItem, ExerciseTierThreeProtocolItem} from "./protocolItem.tsx";
...
export const Finish = ({state}: FinishProps) => {
    return (
        <ul className="list bg-base-100 rounded-box flex">
            ...
            <li className="p-4 pb-2 text-xs opacity-60 tracking-wide">Overview of Workout configuration</li>
            ...
            <li className="list-row">
                ...
                <div>
                    ...
                    <div className="">Chosen day: <span
                        className={"text-xs uppercase font-semibold opacity-60"}> {state.workOutDay}</span></div>
                </div>
            </li>
            ...
            <li className="list-row">
                ...
                <div>
                    <div>Weight</div>
                    <div className="text-xs uppercase font-semibold opacity-60">Starting weight</div>
                </div>
            ...
            <li className="list-row">
                ...
                <div>
                    <div>Protocols</div>
                    <div className="text-xs uppercase font-semibold opacity-60">Set x Reps for each exercise</div>
                </div>
